...
const Scan = (props) => {
  ...
  const BeginScan = (e) => {
    ...
    axios(config)
      ...
      .then(function (response) {
        ...
        if (
          response.data.bottleDetails !== undefined &&
          response.data.bottleDetails !== null
        ) {
  ...
  let PlasticbottleContractAddress =
    "0xcCd9716739B8430AEA337714056FBcd220e582F0";
  ...
  async function addBottleToBlockchain(bottleDetails) {
    ...
    let PlasticbottleContract = new ethers.Contract(
    ...
    try {
      ...
      const index = await PlasticbottleContract.registerBottle(
        qrCode,
        title,
        status,
        parseInt(bottleSize),
    ...
    <AppLayout>
      ...
      <div className="row scan_row">
        <div className="glide__track" data-glide-el="track">
          ...
          <ul
            className="glide__slides scan_options"
            style={{ minWidth: 320, flexDirection: "column" }}
          >
            {
              ...
              currentUser.role === "Manufacturer" && (
                <li
                  ...
                  onClick={() => setDataValue2("isNewScan", "true")}
                >
                  <div
                    className={`card ${data.isNewScan === "true" && "active"}`}
                  >
            ...
            <li
              className="glide__slide"
              onClick={() => setDataValue2("isNewScan", "false")}
            >
        ...
        <div className="col-12 col-xl-8 mb-4">
          <div className="card mb-4">
            <div className="card-body">
              ...
              <p>
                Connected Account: <span class="showAccount"></span>
              </p>
              <form onSubmit={(e) => BeginScan(e)}>
                ...
                >
                  ...
                  <div className="col-sm-10">
                    <input
                      name="qrCode"
                      value={data.qrCode}
                      onChange={(e) => setDataValue2("qrCode", e.target.value)}
                      id="qr_val"
                      disabled
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-sm-10">
                        ...
                        {!SizesArray.includes(data.bottleSize) && (
                          <input
                            value={
                              data.bottleSize !== "Other" ? data.bottleSize : ""
                            }
                            required
                            className="form-control"
                            name="bottleSize"
                ...
                <div className="form-group row mb-0">
                  <div className="col-sm-10">
                    ...
                    >
                      <i className="iconsminds-qr-code"></i>{" "}
